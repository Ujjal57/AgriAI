...
const Navbar = () => {
            ...
            <>
              ...
              {userRole === 'buyer' && cartCount > 0 && (
                <li style={{position:'relative'}}>
                  <Link to="/cart" className="navbar-link-anim navbar-link-bold">Cart</Link>
  ...
  <div style={{
    ...
    <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',
      padding:'16px 22px 10px 18px', borderBottom:'1.5px solid #eaf6ea', background:'#f9fffa'}}>
        ...
        <div style={{display:'flex', gap:8, alignItems:'center'}}>
          {!notifSelectMode && (
            <button onClick={async()=>{
              ...
              setNotifCount(0);
            }} style={{background:'#ecf8f2', color:'#236902', border:'none', borderRadius:8, padding:'4px 14px', fontWeight:700, cursor:'pointer', fontSize:13, boxShadow: '0 2px 12px #d1ffe4a1'}}>
              Mark all as read
            </button>
          )}
          {!notifSelectMode ? (
    ...
    <div style={{maxHeight:370, overflowY:'auto', background:'#f8fefa', padding:'0 2px 8px 2px'}}>
      {(!notifList || !notifList.length) && (
        <div style={{padding:'38px 0', textAlign:'center', color:'#a2b2aa'}}>
      ...
      {Array.isArray(notifList) && notifList.map(n => (
        <div key={n.id} style={{
            ...
            boxShadow:'0 2px 10px rgba(22,119,80,0.05)', borderLeft: n.is_read?'4px solid #f9fff7':'5px solid #36cf6d',
          ...
          {open && (
            <div className="navbar-profile-menu" style={{position:'absolute', right:0, top:52, background:'#fff', border:'1px solid #eee', boxShadow:'0 8px 24px rgba(0,0,0,0.12)', borderRadius:8, minWidth:220, zIndex:200}}>
              ...
              <div className="navbar-profile-links">
                  ...
                  <Link to={userRole === 'farmer' ? "/farmer/history" : "/history"} onClick={() => setOpen(false)} className="navbar-profile-link">History</Link>
